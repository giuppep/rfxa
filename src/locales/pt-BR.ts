export default {
    ...
    calculator: {
        ...
        results: {
            netFinalValue: "Valor final líquido",
            grossFinalValue: "Bruto: {amount}",
            invested: "Investido: {amount}",
            netReturn: "Retorno líquido",
            grossReturn: "Bruto: {value}%",
            months: "{n} meses",
            netAnnualized: "Retorno anualizado líquido",
            grossAnnualized: "Bruto: {value}% a.a.",
            perAnnum: "ao ano",
            taxes: "Impostos",
            iof: "IOF ({rate}%)",
            ir: "IR ({rate}%)",
            holdingPeriod: "{n} dias",
        },
    },
}

export default {
    ...
    calculator: {
        ...
        results: {
            netFinalValue: "Net final value",
            grossFinalValue: "Gross: {amount}",
            invested: "Invested: {amount}",
            netReturn: "Net return",
            grossReturn: "Gross: {value}%",
            months: "{n} months",
            netAnnualized: "Net annualized return",
            grossAnnualized: "Gross: {value}% p.a.",
            perAnnum: "per annum",
            taxes: "Taxes",
            iof: "IOF ({rate}%)",
            ir: "IR ({rate}%)",
            holdingPeriod: "{n} days",
        },
    },
}
